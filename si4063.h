...
static void si4063_configure_chip(chip_parameters chip_params);
static void si4063_configure_rf(radio_parameters params);

static void si4063_configure_data_rate(uint32_t data_rate);
static void si4063_set_frequency_offset(uint16_t offset);
static void si4063_set_frequency_deviation(uint32_t deviation_hz);
static void si4063_set_modulation_type(si4063_modulation_type type);
static void si4063_set_data_rate(const uint32_t rate_bps);
static void si4063_set_tx_power(uint8_t power);
static void si4063_set_tx_frequency(const uint32_t frequency_hz);
static int si4063_set_clock(unsigned int clock);
...
static bool si4063_fifo_underflow();

static uint32_t si4063_calculate_deviation(uint32_t deviation_hz);
uint16_t si4063_read_part_info();

static void si4063_set_state(si4063_state state);
static int si4063_wait_for_cts();
static void si4063_send_command(si4063_command command, uint8_t length, uint8_t *data);
